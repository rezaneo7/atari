...
class ATARI:
    def __init__(self, state_dim, action_dim, save_dir, checkpoint=None):
        ...
        # ATARI's DNN to predict the most optimal action - we implement this in the Learn section
    ...
    def act(self, state):
        ...
        Outputs:
        action_idx (int): An integer representing which action ATARI will perform
        """
        # EXPLORE
